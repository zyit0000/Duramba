...
class MurderersVsSheriffsDuelsProfile : public GenericProfile {
public:
    std::string name() const override { return "Murderers VS Sheriffs Duels"; }
    uint64_t place_id() const override { return 12355337193; }
